...
def create_mix_pickle(spk_path, noise_path, output_path):
    mic_diameter = 0.064
    items = {"train": 50000, "val": 5000, "test": 2000,}
...
def generation(data_type):
    
    pool = mp.Pool(processes=8)
    config_path = "/home/ding/Documents/config/" + data_type + "_16khz.pkl"
    # load pickle file
    with open(config_path, "rb") as f:
        configs = pickle.load(f)
    print(len(configs))
    
    for i in range(5000,len(configs)):
        pool.apply_async(create_mix, (configs[i], i,  "/home/ding/Documents/data/8khz", data_type))
    pool.close()
    pool.join()
...
if __name__ == "__main__":
    # 创建mix pkl文件
    # create_mix_pickle("/home/ding/Documents/LibriSpeech","/home/ding/Documents/LibriSpeech/wham_noise", "/home/ding/Documents/config")
    # 检查pkl文件
    # import time
    # a = parse_pkl("/home/ding/Documents/config/val_16khz.pkl")
    # print(a[5009])
    # for i in range(10):
    #     print(a[i]["ang_list"])
    #     time.sleep(1)
